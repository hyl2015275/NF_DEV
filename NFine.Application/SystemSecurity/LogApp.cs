...
namespace NFine.Application.SystemSecurity
{
    public class LogApp
    {
        ...
        {
            logEntity.F_Date = DateTime.Now;
            logEntity.F_IPAddress = string.IsNullOrEmpty(logEntity.F_IPAddress) ? Net.Ip : logEntity.F_IPAddress;
            logEntity.F_IPAddressName = string.IsNullOrWhiteSpace(logEntity.F_IPAddressName) ? Net.GetLocation(logEntity.F_IPAddress) : logEntity.F_IPAddressName;
