    ...
    $.nfinetab = {
        ...
        activeTab: function () {
            ...
            if (roleId != "" && roleId != undefined) {
                top.$.cookie('nfine_currentmoduleid', roleId, { path: "/" });
            }
            else {
                $.loading(true);
                target.attr('src', currentId).load(function () {
                    $.loading(false);
                });
            }
        ...
        addTab: function () {
            ...
            if (flag) {
                var str = '<a href="javascript:;" class="active menuTab"data-role="' + dataId + '"  data-id="' + dataUrl + '">' + menuName + ' <i class="fa fa-remove"></i></a>';
